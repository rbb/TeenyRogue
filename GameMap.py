...
class game_map():
    ...
    def setedges(self, v, ladder=None):    # TODO: rename to finalize() or something?
        ...
        x = self.X
        y = self.Y
        self.m[0:y, 0  ] = v           # noqa: E241 E226 E202
        self.m[0:y, x-1] = v           # noqa: E241 E226
        self.m[0,   0:x] = v           # noqa: E241 E226
        self.m[y-1, 0:x] = v           # noqa: E241 E226
    ...
    def spread(self, sx, sy):
        if self.m[sy, sx] != WALL:
            self.valid[sy, sx] = 1
        if self.m[sy-1, sx] != WALL and self.valid[sy-1, sx] == UNEXPLORED:  # North    # noqa: E226
            self.spread(sx, sy-1)                                                       # noqa: E226
        if self.m[sy, sx+1] != WALL and self.valid[sy, sx+1] == UNEXPLORED:  # East     # noqa: E226
            self.spread(sx+1, sy)                                                       # noqa: E226
        if self.m[sy+1, sx] != WALL and self.valid[sy+1, sx] == UNEXPLORED:  # South    # noqa: E226
            self.spread(sx, sy+1)                                                       # noqa: E226
        if self.m[sy, sx-1] != WALL and self.valid[sy, sx-1] == UNEXPLORED:  # West     # noqa: E226
            self.spread(sx-1, sy)                                                       # noqa: E226
